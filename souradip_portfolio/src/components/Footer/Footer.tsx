...
export const Footer = () => {
  ...
  const navLinks = [
    ...
    { name: "Resume (PDF)", href: "/Souradip_Roy_Chowdhury_Resume.pdf", external: true },
    { name: "Contact", href: "#contact" },
  ];

  const socialLinks = [
    { icon: Github, href: "https://github.com/souradiproychowdhury-cpu", label: "GitHub" },
    { icon: Linkedin, href: "https://linkedin.com/in/Souradip-Roy-Chowdhury", label: "LinkedIn" },
    { icon: Mail, href: "mailto:souradiproychowdhury@gmail.com", label: "Email" },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 flex flex-col gap-10">
        ...
        <div className="pt-6 border-t border-black/5 dark:border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-muted-foreground">
          ...
          <div className="flex items-center gap-1.5 font-medium text-center md:text-right">
            <span>© {new Date().getFullYear()} Souradip Roy Chowdhury. Built with</span>
