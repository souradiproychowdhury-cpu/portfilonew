...
export const ScrollTimeline = ({
  ...
  return (
    ...
    >
      <div className="text-center pt-6 md:pt-8 pb-12 px-4">
            ...
            {events.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Card className="bg-background border group">
                      <CardContent className="p-6">
                        {dateFormat === "badge" ? (
                          ...
                          <p className="text-lg font-bold text-primary mb-2 transition-colors duration-200 dark:group-hover:text-emerald-300">
                            {event.year}
                          </p>
                        )}
                        <h3 className="text-xl font-bold mb-1 transition-colors duration-200 dark:group-hover:text-emerald-300">
                          {event.title}
                        </h3>
                        {event.subtitle && (
                          <p className="text-muted-foreground font-medium mb-2 transition-colors duration-200 dark:group-hover:text-cyan-200">
                            {event.subtitle}
                          </p>
                        )}
