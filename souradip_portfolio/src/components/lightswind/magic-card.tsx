  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col h-full justify-between
        [&_h3]:transition-colors [&_h3]:duration-200
        [&_p]:transition-colors [&_p]:duration-200
        dark:group-hover:[&_h3]:text-emerald-300
        dark:group-hover:[&_p]:text-cyan-100
        dark:group-hover:[&_.text-muted-foreground]:text-cyan-100
      ">{children}</div>
    </div>
  );
}
